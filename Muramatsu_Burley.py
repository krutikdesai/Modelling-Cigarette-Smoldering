...
eps = 0.97
phi = 0.822    # Void Fraction (Real Density)
Dp  = 3.95e-4  # m
r   = 4.0e-3   # m
d   = 3.7e-5   # m
ks  = 0.3163   # W/m.K
...
LBR = 6.33e-5  # Burn Rate (m/s)
w0  = 0.109    # Moisture Content
RhoT0  = 256   # Total (kg/m^3)
...
phi_w = 0.652           # Void Fraction (Apparent Density)
...
def pzl_W(T, RhoW, Pw): # Water Evaporation
    ...
    c1 = Pw/Pws
    w_eq = c1/(1.76 + 17.38*c1 - 17.92*(c1**2))
    c2 = 133.155e10/LBR
